...
T502 = [T502_450_fittedmodel(t(1:4500))' T502_450_less_fittedmodel(t(:,4501:6001))'];
...
save("good data knock on wood\ONOFF_TEST0_5HZ\interpolated_data", "T501_output", "T501_fittedmodel", "T501_goodness", 'T501', "T502", 'T504', "voltage", 't')