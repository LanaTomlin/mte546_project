...
load("good data knock on wood\ONOFF_TEST5HZ\5Hz_2024_04_04-06_07_27_PM_DATA_SAVE.mat")
...
t = 0:0.1:600;
T501 = [T501_150Lfittedmodel(t(1:1500))', T501_300fittedmodel(t(1501:3000))', T501_750fittedmodel(t(3001:6001))'];
...
save("good data knock on wood\ONOFF_TEST5HZ\interpolated_data", "T501_150Lfittedmodel", "T501_300fittedmodel", "T501_750fittedmodel", "T502_fittedmodel", "T504_fittedmodel", "current_fittedmodel", "voltage_fittedmodel", 'T501', "T502", 'T504', "current", "voltage", 't')